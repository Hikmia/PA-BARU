                    ...
                    <?php
						...
						?>
                          <tr>
							...
							<td><?php echo $row->jml_kegiatan; ?></td>
							<td><?php echo $row->namalengkap; ?></td>
							<td><?= $row->status ?></td> 
                            <td>
                              <a title="Hapus" href="<?php echo site_url(); ?>/admin/delete_tribina/<?php echo $row->BKR; ?>" onclick="return confirm('Are You Sure?');" class="btn btn-sm btn-danger">✕<i class="fa fa-trash"></i></a>
		...
		<div class="modal-content">
			<div class="modal-header">
				...
				<div class="modal-body">
					<form method="post" action="<?php echo site_url('admin/add_tribina') ?>">
						<div class="row">
							...
							<div class="form-group">
								...
								<div class="col-md-12">
									...
									<option value="Pendewasaan usia perkawinan">Pendewasaan usia perkawinan</option>
									<option value="Fungsi keluarga">Fungsi keluarga</option>
									<option value="Nilai gender dalam keluarga">Nilai gender dalam keluarga</option>
									<option value="Seksualitas">Seksualitas</option>
									<option value="NAPZA">NAPZA</option>
									<option value="HIV/AIDS">HIV/AIDS</option>
									<option value="Komunikasi efektif Orangtua terhadap remaja">Komunikasi efektif Orangtua terhadap remaja</option>
									<option value="Peran orangtua dalam pembinaan tumbuh kembang remaja">Peran orangtua dalam pembinaan tumbuh kembang remaja</option>
									<option value="Kebersihan dan kesehatan diri remaja">Kebersihan dan kesehatan diri remaja</option>
									<option value="Pemulihan gizi remaja">Pemulihan gizi remaja</option>
								...
								<div class="form-group">
									<label>Jumlah Kegiatan Pertemuan</label>
									<input type="text" name="jml_kegiatan" placeholder="Jumlah Kegiatan Pertemuan" required="" autofocus="" class="form-control">
								</div>
								<div class="form-group">
...
<div id="edit<?php echo $id ?>" class="modal fade" role="dialog">
	<div class="modal-dialog">
		<div class="modal-content">
		<h3 class="modal-title">Bina Keluarga Balita</h3> <span>Id Anggota : <?php echo $key->BKR?></span>
			<div class="modal-header">
			</div>
				<div class="modal-body">
					<form method="post" action="<?php echo site_url('admin/update_tribina/'.$key->BKR) ?>">
						<div class="row">
							<div class="col col-lg-12">
							<div class="form-group">
									<label>Nama Kelompok Kegiatan</label>
								...
								<div class="form-group">
									<label>Jumlah Kegiatan Pertemuan</label>
									<input type="text" name="jml_kegiatan" placeholder="Jumlah Kegiatan Pertemuan" required="" autofocus="" class="form-control" value="<?php echo $key->jml_kegiatan?>">
								</div>
								<div class="form-group">
									<label>Kode keluarga Indonesia</label>
								...
								<div class="form-group">
									...
									<option value="<?php echo $key->materi?>">Pemulihan gizi remaja</option>
