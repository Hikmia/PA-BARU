	...
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span>BKKBN</span>&nbspKabupaten Jombang</a>
				<ul class="user-menu">
	...
	<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Pencarian Data Keluarga</div>
					<div class="panel-body">
					<form action="<?php echo site_url('admin/cek_DataKeluarga');?>" method = "post">
						<div class="active-pink-3 active-pink-4 mb-4">
						<input type="text" name = "keyword" />
						<button class="btn btn-primary right" data-toggle="modal" data-target="#myModal" type="submit" value="search ">Search</button>
					</form>
					</div>
				</div>
			</div>
