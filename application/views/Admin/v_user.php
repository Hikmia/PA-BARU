...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">Data user <?php if($this->session->userdata('jabatan')==" "){?>
                      ...
                      foreach ($query as $row) {
                          ...
                          <tr>
                            ...
                            <td><?php echo $row->jabatan; ?></td>
								...
								<!-- if($row->jabatan=="kader PPKBD"){echo "Penyuluh kb";}else{ echo "Petugas Puskesmas";} -->
								<!-- if($this->session->userdata('jabatan')=="s"){echo $row->password;}else{ echo "password";} -->
                            <td>
