...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			<li class="<?php if($title=="Dashboard"){echo "active";} ?>"><a href="<?php echo site_url('C_administrator') ?>"><svg class="glyph stroked dashboard-dial"><use xlink:href="#stroked-dashboard-dial"/></svg> Dashboard</a></li>
			<li class="<?php if($title=="Kelola Akun Pengguna"){echo "active";} ?>"><a href="<?php echo site_url('C_administrator/kelola_akun') ?>"><svg class="glyph stroked map"><use xlink:href="#stroked-map"/></svg> Kelola Akun</a></li>
		</ul>
