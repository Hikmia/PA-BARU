...
<title>KADER PPKBD BKKBN Kecamatan Diwek</title>
				...
				<ul class="user-menu">
					<li class="dropdown pull-right">
						...
						<ul class="dropdown-menu" role="menu">
							...
							<li><a href="<?php echo site_url('admin/profil') ?>"><svg class="glyph stroked gear"><use xlink:href="#stroked-gear"></use></svg>Edit Profile</a></li>
						</ul>
					</li>
				</ul>
			</div>
		...
		<ul class="nav menu">
			...
			<li class="parent ">
				...
				<ul class="children collapse" id="sub-item-1">
					...
					<li>
						<a class="<?php if($title=="Pencarian Data"){echo "active";} ?>" href="<?php echo site_url('admin/cek_Data'); ?>">
							<svg class="glyph stroked chevron-right"><use xlink:href="#stroked-chevron-right"></use></svg> Pencarian Data
						</a>
					</li>
				</ul>
			</li>
