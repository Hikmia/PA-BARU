...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">Informasi Pelayanan
		</div>
				 ...
				 <?php if (validation_errors()) : ?>
                  ...
                  <?php
    				if ($offset == "") { $id = 0; } else { $id = $offset; }
						...
						<tr>
						<td><?php echo $id; ?></td>
						<td> <?php echo $key->tglberakhir; ?></td>
						<td> <?php echo $key->deskripsi; ?></td>
						<td><?= $key->status ?></td> 
						<td>
						<a href="<?= site_url('admin/approvedata_informasi/'.$key->id_info) ?>" class="btn btn-success btn-sm text-light">Read</a></td>
						<?php
						}
                        if($query==NULL){
                        ?>
